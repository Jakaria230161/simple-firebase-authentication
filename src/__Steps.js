...
3,visit doc(go to doc):Build > authentication > web > Getting started.
4,Register web app > firebase project home > click web > give name > register
...
9,create a google auth provider , do not forget to use new google auth provider new GoogleAuthProvider();
